...
export const ARG_F = Symbol("ARG_F");
...
export const plus = wr((a) => wr((b) => a + b));
export const spr = (...rawArgs) => {
...
export const vec = (...args) => {
    args.isVec = true;
    const func = (v) => v.isVec
