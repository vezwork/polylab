...
const parentContainer = (e: HTMLElement): HTMLElement | null =>
  e.parentElement?.closest("container") ?? null;

const elFromContainerSink = new MapWithInverse<ContainerSink, HTMLElement>();
const containerSinkFromEl = elFromContainerSink.inverse;

const elFromCaretSink = new MapWithInverse<CaretSink, HTMLElement>();

const Container = (parent: HTMLElement) => {
...
const Caretable = (parent: HTMLElement) => {
