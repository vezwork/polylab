// Modified version of nestedCaret.ts that pulls out caretFunctions and treeFunctions
export function makeNestedCaretFunctions({ getBounds, parent, children, getCarryX, setCarryX, firstSpatialChild, lastSpatialChild, }) {
