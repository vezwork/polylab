...
import { add, mul, sub, dot, basisProj, x, y } from "./Vec2.js";
...
export const width = (ps) => distanceFromSpan(minAndMax(arrLiftFn(x)(ps)));
export const height = (ps) => distanceFromSpan(minAndMax(arrLiftFn(y)(ps)));
