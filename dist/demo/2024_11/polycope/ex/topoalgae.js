export function topoBf(start, nexts, visit, allNodes, ignore = new Set()) {
    const { sccIndex, nodeToScc } = stronglyConnectedComponents(allNodes, (v) => [...nexts(v)].filter((e) => !e.disabledByPassing));
    ...
    while (queue.length > 0) {
        ...
        queue.sort((a, b) => sccIndex.get(nodeToScc.get(a)) - sccIndex.get(nodeToScc.get(b)));
    }
}
...
function stronglyConnectedComponents(allNodes, nexts) {
