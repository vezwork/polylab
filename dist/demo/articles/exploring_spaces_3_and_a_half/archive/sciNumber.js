...
export const sci = (n, pow10 = 0n) => ({
    n: BigInt(n),
    pow10: BigInt(pow10),
});
export const fromSci = (a) => a.n * 10n ** a.pow10;
export const sciLowerPower = (a, pow10) => pow10 > a.pow10
    ? error("pow10 > a.pow10")
    : {
        n: a.n * 10n ** (a.pow10 - pow10),
        pow10,
    };
export const sciAdd = (a, b) => {
