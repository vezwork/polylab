...
const ela = document.querySelector("#dragging2a circle.draggable");
const elb = document.querySelector("#dragging2b circle.draggable");
const clonea = document.querySelector("#dragging2a circle.clone");
const cloneb = document.querySelector("#dragging2b circle.clone");
let state = {
    el: ela,
    clone: cloneb,
