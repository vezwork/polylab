...
export const makeHashcons = (keyValues, setFromId) => {
  ...
  return {
    ...
    [Symbol.iterator]: () =>
      map(_hashcons[Symbol.iterator](), ([heNode, eClass]) => [
...
export const unionHashcons = (a, b) =>
  makeHashcons([...a._hashcons, ...b._hashcons], a._setFromId);
...
export const makeHashset = (items, setFromId, overrideSet) => {
  ...
  return {
    ...
    [Symbol.iterator]: () =>
      map(_set[Symbol.iterator](), (heNode) => unhash(heNode, setFromId)),
    _set,
    _setFromId: setFromId,
  };
};
export const unionHashset = (a, b) =>
  makeHashset(null, a._setFromId, a._set.union(b._set));
