import { add, print, sub, l, framed, level, normalizeRadix, } from "./radixListNum.js";
...
const sstr = (a) => JSON.stringify(a, (key, value) => typeof value === "bigint" ? value.toString() : value);
