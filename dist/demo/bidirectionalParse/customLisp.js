...
const OBJECT_END = "]";
const VALUE_END = ",";
const customArEntry = i_(iw, unwrap(flatStrings(until(or(char(VALUE_END), char(OBJECT_END)))(cases([(a) => a?.message, call(() => marker("hi")(customAr))], [() => true, any])))), ichar(VALUE_END), iw);
// map({
